...
interface InboundProductTableProps {
  page: number;
  setPage: (page: number) => void;
  productItems: NewInboundProduct[] | null;
  setItem: (item: ProductProps) => void;
  setShowAddDialog: (showAddDialog: boolean) => void;
  setProductItems: (productItems: NewInboundProduct[]) => void;
}

const InboundProductTable: React.FC<InboundProductTableProps> = ({
  page,
  setPage,
  productItems,
  setItem,
